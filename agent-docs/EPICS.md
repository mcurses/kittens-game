...
| 39 | **Workshop Engineer Assignment Engine** — add per-craft engineer assignment state and action surface as the engine prerequisite for deferred mechanization UI parity | 09, 35 | P2 | 🚧 In Progress |
