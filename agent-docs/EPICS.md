...
| 38 | **Trade Shortcut Quantity Parity** — replace fixed caravan shortcuts with legacy dynamic `tradeHalf` / `tradeFifth` behavior and matching amount calculations | 35 | P2 | 🚧 In Progress |
