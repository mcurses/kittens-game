...
| 35 | **UI QoL Parity** — close the remaining legacy convenience/UI-density gaps: inline craft shortcuts on resource rows, inspector enrichment (flavor text, automation status, pollution warning), bulk job assignment, per-source production attribution, and mechanization craft controls | 25, 26, 32, 33, 34 | P1 | ✅ Complete |
...
| 46 | **Workshop Tech Unlock Parity** — restore legacy unlock propagation from researched techs into workshop upgrades/crafts during live research, save load, and legacy import so workshop availability matches progression state | 08, 09, 21 | P1 | ✅ Complete |
| 47 | **Workshop Crafting Parity** — craft output preview, cost tooltips, mechanization progress UI, engineer assignment controls, throughput display, and workshop flavor text | 35, 39 | P1 | 🔧 In Progress |
| 48 | **Village Management Parity** — kitten census with filters/sorting, individual kitten management, government/leader display, job loadouts, job tooltips, shift+click assign, bulk hunt | 06, 35 | P1 | ⏳ Not Started |
| 49 | **Buildings Advanced Parity** — stage controls (amphitheatre→broadcastTower), late-game building rename system, filter tabs (All/Available/Enabled/Togglable/IW), almost-limited cap warning | 05, 27, 37 | P2 | ⏳ Not Started |
| 50 | **Resource Display Parity** — resource type color coding, weather production modifier badge, resource visibility toggle, capacity warning colors, craft shortcut tooltips on resource rows | 04, 07, 35 | P2 | ⏳ Not Started |
