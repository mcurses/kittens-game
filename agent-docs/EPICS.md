...
| 47 | **Workshop Crafting Parity** — craft output preview, cost tooltips, mechanization progress UI, engineer assignment controls, throughput display, and workshop flavor text | 35, 39 | P1 | ✅ Complete |
