...
| 40 | **Population/Resource Decoupling** — remove the phantom `kittens` resource row and stop simulating population as a normal resource; keep village population authoritative and expose only the UI data that parity actually requires | 21, 25, 26, 36 | P1 | ⏳ Not Started |
