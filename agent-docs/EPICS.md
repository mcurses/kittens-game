...
| 34 | **Production & Control Parity Audit** — retroactively file and continue the live-save production/control fixes discovered after Epic 33: building enable/disable actions, smelter/steamworks production consumers, legacy toggle visibility rules, and remaining automation gaps | 21, 31, 32, 33 | P1 | 🚧 In Progress |
