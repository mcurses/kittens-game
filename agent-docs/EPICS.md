...
| 45 | **Live Save Import Parity** — make imported legacy saves match live legacy runtime state, especially over-cap resources, derived storage/population stats, and post-import snapshot fidelity | 21, 28, 29, 42 | P0 | ⚠️ Reopened |
