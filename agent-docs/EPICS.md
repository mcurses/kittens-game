...
| 43 | **Dynamic Building Consumer Parity** — restore missing runtime consumers for dynamic harbor, oil well, reactor, and mint effect paths, and downgrade any falsely-complete parity rows until behavior is proven | 21, 31, 34, 42 | P1 | 🔄 In Progress |
| 44 | **Session Management** — full save lifecycle (create, pause/resume, archive, delete, export) with REST API surface, a CLI package, and an admin sessions panel in the web client | 17, 22 | P1 | ⏳ Not Started |
| 45 | **Live Save Import Parity** — make imported legacy saves match live legacy runtime state, especially over-cap resources, derived storage/population stats, and post-import snapshot fidelity | 21, 28, 29, 42 | P0 | 🔄 In Progress |
