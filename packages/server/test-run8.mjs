...
console.log('  hut * 2 + logHouse + mansion = ' + hut + ' * 2 + ' + logHouse + ' + ' + mansion + ' = ' + expected);
console.log('');
console.log('Space buildings (need to find indices):');
// Look for space buildings
const spaceNames = ['spaceStation', 'terraformingStation', 'outerSpaceStation', 'lunaSurface', 'lunaOutpost'];
