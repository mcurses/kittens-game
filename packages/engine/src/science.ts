...
export interface TechDef {
   ...
   * (e.g. "/assets/books/calendar.webp"). Renderers must fall back
...
export const TECH_DEFS: readonly TechDef[] = [
  {
    ...
    iconPath: "/assets/books/calendar.webp",
  ...
  },
  {
    ...
    iconPath: "/assets/books/agriculture.webp",
  ...
  {
    name: "archery",
    iconPath: "/assets/books/archery.webp",
  ...
  {
    name: "mining",
    iconPath: "/assets/books/mining.webp",
  ...
  {
    name: "metal",
    iconPath: "/assets/books/metal.webp",
  ...
  {
    name: "animal",
    iconPath: "/assets/books/animal.webp",
  ...
  {
    name: "civil",
    iconPath: "/assets/books/civil.webp",
  ...
  {
    name: "math",
    iconPath: "/assets/books/math.webp",
  ...
  {
    name: "construction",
    iconPath: "/assets/books/construction.webp",
  ...
  {
    name: "currency",
    iconPath: "/assets/books/currency.webp",
  ...
  {
    name: "writing",
    iconPath: "/assets/books/writing.webp",
  ...
  {
    name: "theology",
    iconPath: "/assets/books/theology.webp",
...
export const POLICY_DEFS: readonly PolicyDef[] = [
  ...
  },
  {
    ...
    prices: [{ name: "culture", val: 2100 }],
    effects: { cathPollutionRatio: -0.05, hydroPlantRatio: 0 },
    blocks: ["lizardRelationsPriests", "lizardRelationsDiplomats"],
  },
  {
    name: "lizardRelationsPriests",
    prices: [{ name: "culture", val: 2100 }],
    effects: { cultureFromManuscripts: -0.25, faithFromManuscripts: 1 },
    blocks: ["lizardRelationsEcologists", "lizardRelationsDiplomats"],
  },
  {
    name: "lizardRelationsDiplomats",
    prices: [{ name: "culture", val: 2100 }],
    effects: { neutralRaceEmbassyStanding: 0.001 },
