...
export const GameActionRequestSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("ENABLE_BUILDING"), name: s, amount: n.int().positive().optional() }),
  z.object({ type: z.literal("DISABLE_BUILDING"), name: s, amount: n.int().positive().optional() }),
  z.object({ type: z.literal("ENABLE_BUILDING_AUTOMATION"), name: s }),
  z.object({ type: z.literal("DISABLE_BUILDING_AUTOMATION"), name: s }),
  z.object({ type: z.literal("ASSIGN_JOB"), job: s, count: n.int().positive().optional() }),
  z.object({ type: z.literal("UNASSIGN_JOB"), job: s, count: n.int().positive().optional() }),
